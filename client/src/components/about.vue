...
<template>
  ...
  >
    <div class="h-[80%] w-[70%] shadow bg-[#feffff] mt-[-4.5rem] p-14">
      <div>
        <img
          src="../assets/images.png"
          alt="FS.simplifier image"
          class="float-right w-[40%] h-[70%] mr-8"
        />
        <h1 class="float-left font-medium text-5xl text-textColor mt-14 ml-14">
          More Information <br />
          About FS.simplifier
        </h1>
      </div>
